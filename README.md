...
Nodes that are currently being visited are represented in pink and frontier nodes (nodes soon to be explored) are represented in crimson. Once the algorithm finds the end the final path is shown in yellow.
